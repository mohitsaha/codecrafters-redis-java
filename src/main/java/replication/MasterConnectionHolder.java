...
public class MasterConnectionHolder {
    ...
    public static replication.MasterConnectionProvider findProvider(Socket socket) {
    ...
    public static void addConnectedList(Socket socket, BufferedWriter writer) {
        MASTER_CONNECTION_PROVIDERS.add(new replication.MasterConnectionProvider(socket, writer));
    }
